...
//var lay=require('express-ejs-layouts');    //To set a layout
...
function restrict(req, res, next) {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     
 ...
 app.post('/upload', multipartMiddleware, user_cont.uplaod);
...
app.post('/search_user', user_cont.search_user);
app.get('/users/delete/:id', user_cont.delete_customer);
app.get('/users/edit/:id', user_cont.edit);
app.post('/user/edit/:id', multipartMiddleware ,user_cont.save_edit);
